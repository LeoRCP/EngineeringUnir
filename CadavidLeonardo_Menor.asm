...
result_msg:     .asciiz "El menor numero es: "
...
main:
    ...
    li $t3, 2147483647         # Inicializar a valor máximo posible en 32 bits
...
input_loop:
    ...
    # Comparar si el número actual es menor que el menor hasta ahora
    bge $t5, $t3, skip_update  # Si el número ingresado es mayor o igual al menor actual, saltar
...
skip_update:
    ...
    li $v0, 4                  # Llamar a syscall para imprimir string
    la $a0, result_msg          # Cargar mensaje "El menor numero es: "
    syscall

    move $a0, $t3              # Cargar el menor número en $a0 para mostrarlo
